...
public class EmailService {
    public EmailService() {
        System.out.println("Running EmailService, polling from SQS.");
        sendEmails(fetchMessagesFromQueue());
        System.out.println("EmailService run is complete.");
    }
    ...
    private List<EmailModel> fetchMessagesFromQueue() {
        ...
        String emailQueueUrl = "https://sqs.eu-north-1.amazonaws.com/254165177835/emailQueue";
    ...
    private void sendEmails(List<EmailModel> emails) {
        ...
        for(EmailModel email: emails) {
            SendEmailRequest request = new SendEmailRequest()
                    ...
                    .withSource("david.sundelius@proagile.se");
